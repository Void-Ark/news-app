...
//   ];
  ...
  constructor(){
	...
	async extract(){
		let URL = `https://newsapi.org/v2/top-headlines?country=in&apiKey=35a79ed2b6b8482e8aec24305ad12652&page=${this.state.page}`;
    ...
    return (
      <div className='container'>
            ...
            (element)=>{
							return (element.title === "[Removed]") ? '' :
								<NewsItem 
									...
									url={element.url?element.url:"https://media.cnn.com/api/v1/images/stellar/prod/230914134624-08-hunter-biden-072623.jpg?c=16x9&q=w_800,c_fill"}
        ...
        <div className="container d-flex justify-content-between">
            <button className="btn btn-primary" type='button' onClick={this.handlePrevClick} disabled={this.state.page === 1}>&larr; Previous</button>
